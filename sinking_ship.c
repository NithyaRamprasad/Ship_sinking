...
void display1(void)
{
	...
	glEnd();
	glColor3f(1, 1, 1);
	bitmap_output(240, 630, "CAMBRIDGE INSTITUTE OF TECHNOLOGY", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 1, 1);
	bitmap_output(128, 590, "DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 0, 1);
	bitmap_output(350, 530, "A Mini Project On", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(0.5, 0.8, 0);
	bitmap_output(380, 480, "Ship Sinking", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 0, 1);
	bitmap_output(100, 420, "By", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 0, 0);
	bitmap_output(150, 370, "Name: Nithyashree R USN:1CD19CS111 ", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 0, 0);
	bitmap_output(150, 330, "Name:Parijatha G S USN:1CD19CS116", GLUT_BITMAP_TIMES_ROMAN_24);

	glColor3f(1, 0, 1);
	bitmap_output(100, 240, "Guides", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 0, 0);
	bitmap_output(150, 200, "Name: Prof. Priyadarshini M", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 0, 0);
	bitmap_output(150, 160, "Name: Prof. Rajesh Kumar S", GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1, 0, 0);
